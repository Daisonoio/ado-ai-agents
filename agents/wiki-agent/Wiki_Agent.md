...
- If a parent page creation fails, all its children are skipped and reported in Step 9.
...
### S3.1 — General content generation rules
...
### S3.2 — Content hint interpretation rules
...
### S3.4 — Active modules and content hints interaction
...
### Step 0 — Read the style and formatting guide
...
evidence signals as defined in the Privileges page rules in S3.
...
3. Apply all style guide rules to drafted content.
